# Honeymoon — Tour du Mont Blanc

**Aug 5 – 20, 2026** · Pre-trip buffer → **TMB (Aug 7–16)** → Annecy spa → Geneva → fly home  
**Travelers:** Matthew Gallant + Sophia Slobodnik
...
**Booking reference:** A9XLOT · Economy · 2 passengers

#### Outbound — DEN → GVA

| | |
| - | - |
| **Depart** | Tue, Aug 4 · 11:25 AM · Denver (DEN) |
| **Arrive** | Wed, Aug 5 · 9:55 AM · Geneva (GVA) |
| **Duration** | 14h 30m · 1 stop |
| **Airlines** | Brussels Airlines SN9574 · Air Canada SN9583 |

| Passenger | E-ticket | Baggage |
| --------- | -------- | ------- |
| Matthew Gallant | 0827409512855 | 1 personal item · 1 carry-on (8 kg max) · no checked bags |
| Sophia Slobodnik | 0827409512858 | 1 personal item · 1 carry-on (8 kg max) · no checked bags |
...
| | |
| - | - |
| **Depart** | Thu, Aug 20 · 8:50 AM · Geneva (GVA) |
| **Arrive** | Thu, Aug 20 · 1:45 PM · Denver (DEN) |
| **Duration** | 12h 55m · 1 stop |
| **Airlines** | Lufthansa LH2383 · LH480 |
...
- GVA → Les Houches · check in · rest
- Confirm refuge emails · download offline maps

#### Thu, Aug 6 — Prepare

**Lodging:** RockyPop Chamonix *(night 2 of 2 · check-out Fri Aug 7)*  
**Payment:** Paid in full — same booking

- Gear check · missing-item shopping · optional acclimatization walk
- Research Bellevue gondola (Day 1) · confirm Aug 8 bus schedule
...
- Long stage in one push — rest day tomorrow

---

#### Rest Day — Sun, Aug 10 · Courmayeur

**Lodging:** Same Airbnb *(night 2 of 2)*  
**Payment:** Covered by Aug 9 booking

- Date night — Italian restaurants in town
- Optional spa: [QC Terme Monte Bianco](https://www.qcterme.com/destinations/mont-blanc/qc-spa-monte-bianco) — €60 entry / €240 couples massage + spa
...
#### Day 9 — Sun, Aug 16 · Argentière → Les Houches *(finish)*
...
**Lodging:** Les Trésoms *(night 2 of 3)*  
**Payment:** Same booking

#### Tue, Aug 18 · Annecy

**Lodging:** Les Trésoms *(night 3 of 3)*  
**Payment:** Same booking

#### Wed, Aug 19 · Annecy → Geneva

**Lodging:** ibis Genève Aéroport · Chemin de la Violette 10 · check-in from **3:00 PM** · check-out Thu Aug 20 by **12:00 PM**  
**Payment:** **Paid** · CHF 101.79 via Booking.com (Amex ·2153) · conf **5006114318** · **CHF 8.50 city tax due at property** · non-refundable

- Check out Les Trésoms before 11:00 AM
- transfer to Geneva 
- Standard Double Room

#### Thu, Aug 20 · Fly Home

**Lodging:** ibis Genève Aéroport *(check-out by 12:00 PM)*  
**Payment:** City tax only at check-out

**Flight:** **GVA 8:50 AM → DEN 1:45 PM** · LH2383 / LH480 · ref **A9XLOT**

- Short hop to terminal
